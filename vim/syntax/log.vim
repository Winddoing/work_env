...
syn keyword logBoolean    TRUE FALSE True False true false enable disable
...
syn keyword logLevelCritical CRITICAL CRIT FATAL critical crit fatal Fatal
syn keyword logLevelError ERROR ERR FAILURE SEVERE error err failure severe Error Err fail Fail
syn keyword logLevelWarning WARNING WARN warning warn Warning Warn
syn keyword logLevelNotice NOTICE notice
syn keyword logLevelInfo INFO
syn keyword logLevelDebug DEBUG FINE debug fine Debug
syn keyword logLevelTrace TRACE FINER FINEST trace finer finest Trace
