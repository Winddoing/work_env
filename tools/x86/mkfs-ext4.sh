...
usage()
{
	echo "Usage: mkfs-ext4.sh -b 0 -N 0 -d rootfs"
	echo ""
	...
	echo "	-d target dir"
	echo ""
	echo "100M space size filesystem:"
	echo "	mkfs-ext4.sh -b 100 -N 498 -d rootfs"
	echo "Default space size filesystem:"
	echo "	mkfs-ext4.sh -b 0 -N 0 -d rootfs"
